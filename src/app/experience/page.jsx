...
function ExperiencePage() {
    ...
    const experiences = [
        ...
        },
        {
            ...
            role: "ABO Partner",
            period: "2025 - ปัจจุบัน",
            description: "I am a businessman with Amway",
            logo: "/Experience/amway.png",
            image: "/Experience/ABO.png",
            imageDesc: "I invite people to buy products and look for those who want to learn about the real MLM business.",
            delay: 600,
        },
        {
            company: "Amway",
            role: "My Store",
            period: "2025 - ปัจจุบัน",
            description: "I hvae an online store on Amway.",
            logo: "/Experience/amway.png",
            image: "/Experience/MyStore.png",
            imageDesc: "My store, BodyFuel Lab, offers a wide range of premium nutrition and wellness products, including proteins and body care items that help restore and rejuvenate the body.",
            delay: 600,
        },
    ];
